...
enchant.util = { assets: ['http://jsrun.it/assets/5/R/s/1/5Rs1X.gif', 'http://jsrun.it/assets/t/J/h/6/tJh6D.gif', 'http://jsrun.it/assets/4/a/I/1/4aI1i.png'] };
// 背景専用スプライト
...
enchant.util.MutableText = enchant.Class.create(enchant.Sprite, {
	...
	setText: function(txt) {
		...
		for(i=0; i<txt.length; i++) {
			...
			this.image.draw(enchant.Game.instance.assets['http://jsrun.it/assets/4/a/I/1/4aI1i.png'], 
...
enchant.util.LifeLabel = enchant.Class.create(enchant.Group, {
	initialize: function(x, y, maxlife) {
		...
		for(var i=0; i<this._maxlife; i++){
			...
			this.heart[i].image = enchant.Game.instance.assets['http://jsrun.it/assets/t/J/h/6/tJh6D.gif'];

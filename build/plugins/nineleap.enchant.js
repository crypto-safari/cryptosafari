...
(function () {
    ...
    enchant.nineleap = { assets: ['http://jsrun.it/assets/a/i/l/c/ailco.png', 'http://jsrun.it/assets/6/k/M/p/6kMpi.png'] };
    /**
    ...
    enchant.nineleap.Game = enchant.Class.create(enchant.Game, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets['http://jsrun.it/assets/a/i/l/c/ailco.png'];
                ...
                this.endScene.image = this.assets['http://jsrun.it/assets/6/k/M/p/6kMpi.png'];
            });
